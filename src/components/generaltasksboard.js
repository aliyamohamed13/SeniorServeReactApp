...
class GeneralTasksBoard extends Component {
	...
	handleAddTask = () => {
		...
		if ((this.state.Date === "") ||
			...
			var apiAddressPostUrl = "https://seniorserve-spring-postgres.herokuapp.com/api/v1/location/"
	...
	finishAddTask = () => {
		var apiTaskPostUrl = "https://seniorserve-spring-postgres.herokuapp.com/api/v1/task/"
	...
	finishAddPref = (randomTaskID) => {
		var apiPrefPostUrl = "https://seniorserve-spring-postgres.herokuapp.com/api/v1/preference/taskPref=" + randomTaskID + "&"
		console.log(this.state.AddTaskPreferencesID)
