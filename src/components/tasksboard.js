...
class TasksBoard extends Component {
	...
	componentDidMount() {
		...
		fetch("https://seniorserve-spring-postgres.herokuapp.com/api/v1/task/incompleteTasks/username=" + this.props.username)
			...
			.catch(console.log);
		fetch("https://seniorserve-spring-postgres.herokuapp.com/api/v1/taskcompletion/allTask/username=" + this.props.username)
			.then(res => res.json())
			.then(data => {
	...
	handleDeleteTask = (taskID) => {
		console.log(taskID)
		var taskDeleteUrl = "https://seniorserve-spring-postgres.herokuapp.com/api/v1/task/task_ID=" + taskID
	...
	handlePostTask = () => {
		if ((this.state.Date === "") ||
			...
			var updateUrl = "https://seniorserve-spring-postgres.herokuapp.com/api/v1/location"
	...
	finishUpdateTask = () => {
		var putUpdateString = "https://seniorserve-spring-postgres.herokuapp.com/api/v1/task/"
	...
	handleMarkCompletePost = () => {
		if ((this.state.completeDate === "") ||
			...
			var postUrl = "https://seniorserve-spring-postgres.herokuapp.com/api/v1/taskcompletion/taskCompletionRecord"
			axios.post(postUrl, {
	...
	reset = () => {
		axios.get("https://seniorserve-spring-postgres.herokuapp.com/api/v1/task/incompleteTasks/username=" + this.props.username)
			.then(res => {
				console.log("reset!")
				this.setState({ userTaskInfo: res.data });
			})
			.catch()
		axios.get("https://seniorserve-spring-postgres.herokuapp.com/api/v1/taskcompletion/allTask/username=" + this.props.username)
			.then(result => {
				console.log("reset!")
