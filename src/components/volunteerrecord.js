          ...
          <div key={record.record_ID} className="card">
            <div className="card-body">
              {record.description !== null ? (
                <div className="card-title"> Task: {record.description} </div>
              ) : (
                <div></div>
              )}
              {record.task_id !== null ? (
                <div className="card-title"> TaskID: {record.task_id} </div>
              ) : (
                <div></div>
              )}
              {record.timeOfDay !== null ? (
                <div className="card-title">
                  {" "}
                  Time Volunteered: {record.timeOfDay}{" "}
                </div>
              ) : (
                <div></div>
              )}
              ...
              {record.hours !== null ? (
                <p className="card-text"> Hours: {record.hours} </p>
              ) : (
                <p></p>
              )}
            </div>
