...
class MakeReview extends Component {
	...
	componentDidMount() {
		fetch("https://seniorserve-spring-postgres.herokuapp.com/api/v1/user/volunteer")
			.then(res => res.json())
			.then(data => {
	...
	handleAddReview = () => {
		var apiTaskPostUrl = "https://seniorserve-spring-postgres.herokuapp.com/api/v1/review/"
