...
class Reviews extends Component {
	...
	componentDidMount() {
		...
		fetch("https://seniorserve-spring-postgres.herokuapp.com/api/v1/review/")
			.then(res => res.json())
			.then(data => {
				this.setState({ reviewInfo: data });
			})
			.catch(console.log);
		fetch("https://seniorserve-spring-postgres.herokuapp.com/api/v1/review/distinctUsersWithReviews")
			.then(res => res.json())
			.then(data => {
				this.setState({ volunteers: data });
			})
			.catch(console.log);
		fetch("https://seniorserve-spring-postgres.herokuapp.com/api/v1/user/seniorUsername")
			.then(res => res.json())
			.then(data => {
	...
	handleSubmitVolunteer = (event) => {
		...
		if (this.state.volunteerUserName !== "") {
			axios.get("https://seniorserve-spring-postgres.herokuapp.com/api/v1/review/volunteer=" + this.state.volunteerUserName)
				.then(result => {
					console.log(result)
			...
			axios.get("https://seniorserve-spring-postgres.herokuapp.com/api/v1/review/averageRating/volunteer=" + this.state.volunteerUserName)
				.then(response => {
	...
	handleSubmitSenior = (event) => {
		...
		if (this.state.seniorUsername !== "") {
			axios.get("https://seniorserve-spring-postgres.herokuapp.com/api/v1/review/senior=" + this.state.seniorUsername)
				.then(result => {
					console.log(result)
					console.log(result.data)
					this.setState({ reviewInfo: result.data })
			...
			axios.get("https://seniorserve-spring-postgres.herokuapp.com/api/v1/review/averageRating/senior=" + this.state.seniorUsername)
				.then(response => {
					console.log(response)
					console.log(response.data)
					this.setState({ averageRating: response.data })
